...
![Figure 1: Communication protocol between SLiM-Gym and SLiM recipe. Synchronization between SLiM and SLiM-Gym is achieved through two mechanisms: SLiM’s output logging and the signaling file..\label{fig:slim-communication}](figures/figure1.png)
